...
class VITONHDDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform_size is None and self.transform_color is None:
            ...
            agn_mask = imread(
                opj(self.drd, self.data_type, "agnostic-mask", self.im_names[idx].replace(".jpg", ".jpg")), 
                self.img_H, 
                self.img_W, 
                is_mask=True, 
            ...
            agn_mask = imread_for_albu(opj(self.drd, self.data_type, "agnostic-mask", self.im_names[idx].replace(".jpg", ".jpg")), is_mask=True)
