...
def build_args():
    ...
    parser.add_argument("--data_root_dir", type=str, default="./uploaded_files")
    parser.add_argument("--category", type=str, default=None, choices=["upper", "lower_body", "dresses"])
    parser.add_argument("--vae_load_path", type=str, default="./StableVITON/ckpts/VITONHD_VAE_finetuning.ckpt")
    ...
    parser.add_argument("--save_root_dir", type=str, default="./StableVITON/logs")
    ...
    args.config_path = opj("./StableVITON/configs", f"{args.config_name}.yaml")
