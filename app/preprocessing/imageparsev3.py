...
# # Define constants
# CONDA_ENV_NAME = "test"
# # SCRIPT_PATH = r"D:\assignments\fyp\final evaluation\CIHP_PGNcode\inference_pgn.py"
...
# base_dir = os.getcwd()
# SCRIPT_PATH = os.path.join(base_dir, "CIHP_PGNcode", "inference_pgn.py")
# INPUT_FOLDER = os.path.join(base_dir,  "CIHP_PGNcode", "datasets")
# TEMP_FOLDER = os.path.join(base_dir, "CIHP_PGNcode", "datasets", "temp")
...
base_dir = os.getcwd()
SCRIPT_PATH = os.path.join("preprocessing", "CIHP_PGNcode", "inference_pgn.py")
