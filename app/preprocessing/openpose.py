...
# # image_path = r"D:\assignments\fyp\final evaluation\website\uploads\image\random.jpg" 
# # output_dir_img = r"D:\assignments\fyp\final evaluation\website\uploads\openpose_img"                
# # output_dir_json = r"D:\assignments\fyp\final evaluation\website\uploads\openpose_json"                
# # openpose_dir = "D:/downloads/openpose-1.7.0-binaries-win64-gpu-python3.7-flir-3d_recommended/openpose" 

# base_dir = os.getcwd()
# image_path = os.path.join(base_dir, "uploads", "image", "random.jpg")
# output_dir_img = os.path.join(base_dir, "uploads", "openpose_img")
# output_dir_json = os.path.join(base_dir, "uploads", "openpose_json")
# openpose_dir = os.path.join(base_dir, "openpose-1.7.0-binaries-win64-gpu-python3.7-flir-3d_recommended", "openpose")
