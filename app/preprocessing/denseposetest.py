...
# base_dir = os.getcwd()
# input_dir = os.path.join(base_dir, "uploads", "test", "image")
# output_dir = os.path.join(base_dir, "uploads", "test", "image-densepose")
# working_dir = os.path.join(base_dir, "detectron2", "projects", "DensePose")
...
# folder_path = r"D:/assignments/fyp/final evaluation/website/uploads/test/image-densepose/"
