...
#folder_path = r"D:\assignments\fyp\final evaluation\website\uploads\image-parse-v3"  # Replace with your folder path
base_dir = os.getcwd()
folder_path = os.path.join(base_dir, "uploads", "image-parse-v3")
new_width = 768
new_height = 1024
